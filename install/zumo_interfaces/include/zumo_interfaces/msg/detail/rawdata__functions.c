...
zumo_interfaces__msg__Rawdata__init(zumo_interfaces__msg__Rawdata * msg)
{
  ...
  // red_list
  if (!geometry_msgs__msg__Polygon__Sequence__init(&msg->red_list, 0)) {
    zumo_interfaces__msg__Rawdata__fini(msg);
    return false;
  }
  // blue_list
  if (!geometry_msgs__msg__Polygon__Sequence__init(&msg->blue_list, 0)) {
    zumo_interfaces__msg__Rawdata__fini(msg);
    return false;
  }
  // yellow_list
  if (!geometry_msgs__msg__Polygon__Sequence__init(&msg->yellow_list, 0)) {
    zumo_interfaces__msg__Rawdata__fini(msg);
    return false;
  }
  return true;
...
zumo_interfaces__msg__Rawdata__fini(zumo_interfaces__msg__Rawdata * msg)
{
  ...
  // red_list
  geometry_msgs__msg__Polygon__Sequence__fini(&msg->red_list);
  // blue_list
  geometry_msgs__msg__Polygon__Sequence__fini(&msg->blue_list);
  // yellow_list
  geometry_msgs__msg__Polygon__Sequence__fini(&msg->yellow_list);
}
