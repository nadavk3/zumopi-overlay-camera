...
static const _Robotlocation_type_support_symbol_names_t _Robotlocation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zumo_interfaces, msg, Robotlocation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zumo_interfaces, msg, Robotlocation)),
  }
};
...
{
  return &::zumo_interfaces::msg::rosidl_typesupport_cpp::Robotlocation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zumo_interfaces, msg, Robotlocation)() {
  return get_message_type_support_handle<zumo_interfaces::msg::Robotlocation>();
}
