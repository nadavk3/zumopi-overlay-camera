...
static const _Rawdata_type_support_symbol_names_t _Rawdata_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zumo_interfaces, msg, Rawdata)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zumo_interfaces, msg, Rawdata)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zumo_interfaces, msg, Rawdata)() {
  return &::zumo_interfaces::msg::rosidl_typesupport_c::Rawdata_message_type_support_handle;
}
