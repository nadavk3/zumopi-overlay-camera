...
#include "zumo_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Robotlocation_type_support_symbol_names_t _Robotlocation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zumo_interfaces, msg, Robotlocation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zumo_interfaces, msg, Robotlocation)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_zumo_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zumo_interfaces, msg, Robotlocation)() {
  return &::zumo_interfaces::msg::rosidl_typesupport_c::Robotlocation_message_type_support_handle;
}
